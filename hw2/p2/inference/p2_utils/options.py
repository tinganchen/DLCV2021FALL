...
parser.add_argument('--source_dir', type = str, default = 'p2_best_model/', help = 'The directory where the teacher model saved.')
...
parser.add_argument('--classifer_model', type = str, default = 'p2_best_model/Classifier.pth', help = 'The classifier model.')
