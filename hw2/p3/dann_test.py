...
def main():
    ...
    tgt_best_prec1, tgt_best_prec5, tgt_best_prec1_domain = test(args, tgt_data_loader_test, 
                                                                 model_t, 0, 'target')

    print_logger.info(f'Best @prec1: {tgt_best_prec1:.3f} @prec5: {tgt_best_prec5:.3f} [Target class]')
    print_logger.info(f'Best @acc: {tgt_best_prec1_domain[0]:.3f} [Target domain]')
